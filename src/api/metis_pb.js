...
proto.api.CreateModelResponse.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getModel();
  if (f != null) {
    writer.writeMessage(1, f, proto.api.Model.serializeBinaryToWriter);
  }
};
...
proto.api.CreateModelResponse.prototype.getModel = function () {
  return /** @type{?proto.api.Model} */ (jspb.Message.getWrapperField(this, proto.api.Model, 1));
};
...
proto.api.CreateProjectResponse.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(1, f, proto.api.Project.serializeBinaryToWriter);
  }
};
...
proto.api.CreateProjectResponse.prototype.getProject = function () {
  return /** @type{?proto.api.Project} */ (jspb.Message.getWrapperField(this, proto.api.Project, 1));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.api.ListProjectsResponse.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        projectsList: jspb.Message.toObjectList(msg.getProjectsList(), proto.api.Project.toObject, includeInstance),
      };
...
proto.api.ListProjectsResponse.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.api.Project.serializeBinaryToWriter);
  }
};
...
proto.api.ListProjectsResponse.prototype.getProjectsList = function () {
  return /** @type{!Array<!proto.api.Project>} */ (jspb.Message.getRepeatedWrapperField(this, proto.api.Project, 1));
};
      ...
      case 3:
        ...
        reader.readMessage(value, function (message, reader) {
          jspb.Map.deserializeBinary(
            ...
            proto.api.Model.deserializeBinaryFromReader,
            '',
            new proto.api.Model(),
          );
        });
...
proto.api.Project.prototype.getModelsMap = function (opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.api.Model>} */ (jspb.Message.getMapField(
    this,
    3,
    opt_noLazyCreate,
    proto.api.Model,
...
proto.api.DiagramInfo.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getOffset();
  if (f != null) {
    writer.writeMessage(1, f, proto.api.Position.serializeBinaryToWriter);
  }
  f = message.getZoom();
  if (f !== 0.0) {
...
proto.api.DiagramInfo.prototype.getOffset = function () {
  return /** @type{?proto.api.Position} */ (jspb.Message.getWrapperField(this, proto.api.Position, 1));
};
...
proto.api.Block.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(4, f, proto.api.Position.serializeBinaryToWriter);
  }
...
proto.api.Block.prototype.getPosition = function () {
  return /** @type{?proto.api.Position} */ (jspb.Message.getWrapperField(this, proto.api.Position, 4));
};
  ...
  proto.api.Model.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        dependenciesMap: (f = msg.getDependenciesMap())
          ? f.toObject(includeInstance, proto.api.Dependency.toObject)
          : [],
      ...
      case 5:
        ...
        reader.readMessage(value, function (message, reader) {
          jspb.Map.deserializeBinary(
            ...
            jspb.BinaryReader.prototype.readString,
            jspb.BinaryReader.prototype.readMessage,
            proto.api.Dependency.deserializeBinaryFromReader,
            '',
            new proto.api.Dependency(),
          );
        });
        break;
      case 6:
        ...
        reader.readMessage(value, function (message, reader) {
          jspb.Map.deserializeBinary(
            ...
            jspb.BinaryReader.prototype.readString,
            jspb.BinaryReader.prototype.readMessage,
            proto.api.Block.deserializeBinaryFromReader,
            '',
            new proto.api.Block(),
          );
        });
      ...
      case 7:
        ...
        reader.readMessage(value, function (message, reader) {
          jspb.Map.deserializeBinary(
            ...
            jspb.BinaryReader.prototype.readString,
            jspb.BinaryReader.prototype.readMessage,
            proto.api.Link.deserializeBinaryFromReader,
            '',
            new proto.api.Link(),
          );
        });
...
proto.api.Model.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(4, f, proto.api.DiagramInfo.serializeBinaryToWriter);
  }
...
proto.api.Model.prototype.getDiagramInfo = function () {
  return /** @type{?proto.api.DiagramInfo} */ (jspb.Message.getWrapperField(this, proto.api.DiagramInfo, 4));
};
...
proto.api.Model.prototype.getDependenciesMap = function (opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.api.Dependency>} */ (jspb.Message.getMapField(
    this,
    5,
    opt_noLazyCreate,
...
proto.api.Model.prototype.getBlocksMap = function (opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.api.Block>} */ (jspb.Message.getMapField(
    this,
    6,
    opt_noLazyCreate,
    proto.api.Block,
...
proto.api.Model.prototype.getLinksMap = function (opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.api.Link>} */ (jspb.Message.getMapField(
    this,
    7,
    opt_noLazyCreate,
    proto.api.Link,
